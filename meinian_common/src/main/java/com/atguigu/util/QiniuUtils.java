...
public class QiniuUtils {
    public  static String accessKey = "DInjwNTxIFw6wbVXBRW3g_992iCzeDbLH4SXZklE";
    public  static String secretKey = "4BDCXuJVVMm_psL8tHrfMaGx3DQBY2F-XaRcDQjs";
    public  static String bucket = "meinianl-wl";
